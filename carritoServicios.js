...
productosServicios.forEach((producto)=> {
    ...
    <p>${producto.desc}</p>
    <button class="btn">
        <a class="__contactar" href="https://wa.me/549${producto.tel}?text=Hola%20desde%20SYPSY,%20Quiero%20su%20servicio"><i class="fa-brands fa-whatsapp icon"></i> Contactar</a>
    </button>
    `
...
//     const item = productosServicios.find((prod) => prod.id === prodId)
//     carrito.push(item)
//     actualizarCarrito()
// }
