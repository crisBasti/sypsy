...
productosIndu.forEach((producto)=> {
...
pagarTotal.addEventListener('click', ()=>{
    const pagoQr = document.createElement('div');
        ...
        <hr>
        <a href ="https://wa.me/5491164521118?text=Hola%20este%20es%20mi%20pedido%20:%20total%20Productos:%20${carrito.length}%20${modalContainer.textContent}%20Precio%20Total:%20${precioTotal.textContent}%20">Arreglar el envio y el pago <br><i class="fa-brands fa-whatsapp"></i></a>`
